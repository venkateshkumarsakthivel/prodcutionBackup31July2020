            ...
            if(state === "SUCCESS") {
                ...
                if(response.getReturnValue() == 'SUCCESS') {
                        ...
                        if (state === "SUCCESS"){
                            ...
                            if(licenseClass === 'TX03'){
                                ...
                                toastEvent.setParams({
                                    "message": "Surrender for a TX03 license has to be initiated from the corresponding TX03WAT license.",
                                    "duration" : 6000,
                                    "mode" : "pester",
                                    "type" : "warning"
                                });
                    ...
                    toastEvent.setParams({
                        ...
                        "message": "Surrender is not a valid action on this authorisation.",
                        "duration" : 6000,
                        "mode" : "pester",
                        "type" : "error"
                    });
                    ...
                    $A.get("e.force:closeQuickAction").fire()
                        ...
                        $A.get("e.force:closeQuickAction").fire()
                            ...
                            var toastEvent = $A.get("e.force:showToast");
                            toastEvent.setParams({
                                "message": "Surrender cannot be performed as there is another operation in progress",
                                "duration" : 6000,
                                "mode" : "pester",
                                "type" : "error"
                            });
	                    ...
	                    else if(response.getReturnValue() == 'RequestInRenewalPeriod'){
	                        console.log('RequestInRenewalPeriod');
	                        var toastEvent = $A.get("e.force:showToast");
	                        toastEvent.setParams({
	                            "message": "Surrender cannot be performed as the Licence Expiry date is less than 28 days",
	                            "duration" : 6000,
	                            "mode" : "pester",
	                            "type" : "error"
	                        });

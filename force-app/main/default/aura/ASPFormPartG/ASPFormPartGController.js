({
    ...
    renderPrevSection : function(component, event, helper) {
        ...
        if(component.get("v.entityType") == "Individual Partner"
            ...
            var nextSectionEvent = component.getEvent("loadSection");
            nextSectionEvent.setParams({"sectionName": "sectionB-P", "caseId" : component.get("v.caseId"), "entityType" : component.get("v.entityType")});
            nextSectionEvent.fire();
        }
        else {
        
            var tempCaseId = component.get("v.caseId");
            nextSectionEvent.setParams({"sectionName": "sectionDVDAccess", "caseId" : tempCaseId, "entityType" : component.get("v.entityType")});
            nextSectionEvent.fire();
        }
    },

({
    ...
    validateTPR : function(component, event) {
        
        this.showSpinner(component, event);
        //validate if account has active registrations
        var activeRegistrationAction = component.get("c.getTaxPayerRegistrationRecord");
        activeRegistrationAction.setCallback(this,function(response) {
            ...
            if(state === "SUCCESS") {
             ...
             component.set("v.hasTPR",response.getReturnValue());
             console.log('functionchecking ' + component.get("v.hasTPR"));
            }
